...
?>
		...
		<div class="box">
        	...
        	<td>
        		...
        		<td>Subtotal: R$ <?php echo $sub_total = number_format($fetch_cart['price'],2) * ($fetch_cart['quantity'])?></td>
        		<td>
				<a href="shopcart.php?remove=<?php echo $fetch_cart['id']; ?>" class="btn-green" 
	...
	<?php
		 ...
		 $double_total = number_format($grand_total, 2);
		 $grand_total = $double_total;
            }
         }else{
    ...
    <td colspan="2" style="font-weight: bold">Total da compra: R$ <?php echo $grand_total; ?></td>
	<td>
	
	<td>
	<b>Forma de pagamento:</b>
	<form action= "delivery.php" method="POST">
	<input type="radio" name="Payment" value="débito" checked><label for="rd1">Débito</label><br>
	<input type="radio" name="Payment" value="crédito"><label for="rd2">Crédito</label><br>
	<input type="radio" name="Payment" value="PIX"><label for="rd3">PIX</label><br>
	</td>
	<td>
	<input type="submit" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" value="Ir para pagamento" name="Ir para pagamento">
	</td>
